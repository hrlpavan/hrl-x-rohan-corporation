...
```mermaid
flowchart TD
    Consolidated["Total Consolidated Platform Budget: ₹56,50,000"]
    
    Consolidated --> P1["Phase 1: Foundational MVP (₹18,00,000)<br/><i>31.9% of Total Budget</i>"]
    Consolidated --> P2["Phase 2: v3.0-v3.4 Enterprise Expansion (₹38,50,000)<br/><i>68.1% of Total Budget</i>"]

    P1 --> A1["3D Digital Twin & Shaders: ₹6,50,000"]
    P1 --> A2["Edge IoT Gateways: ₹5,00,000"]
    P1 --> A3["Photogrammetry & Drone Data: ₹3,50,000"]
    P1 --> A4["Global CDN & Hosting: ₹1,50,000"]
    P1 --> A5["RERA & DPDP Compliance: ₹1,50,000"]

    P2 --> B1["Universal Stock Market & Capital Terminal: ₹5,50,000"]
    P2 --> B2["3D Axonometric & Solar Azimuth Engine: ₹6,00,000"]
    P2 --> B3["Studio Human Voice Narration Engine: ₹4,50,000"]
    P2 --> B4["19-Pillar Venture Architecture & Matrix: ₹6,50,000"]
    P2 --> B5["Edge BMS Ultrasonic & Microgrid Enclaves: ₹8,00,000"]
    P2 --> B6["Standalone Microsites & Yield Engines: ₹4,50,000"]
    P2 --> B7["Executive P&L & Waterfall Simulators: ₹3,50,000"]

    style Consolidated fill:#0f172a,stroke:#dfb76c,stroke-width:2px,color:#ffffff
    style P1 fill:#1e293b,stroke:#38bdf8,stroke-width:1px,color:#ffffff
    style P2 fill:#1e293b,stroke:#10b981,stroke-width:1px,color:#ffffff
```
