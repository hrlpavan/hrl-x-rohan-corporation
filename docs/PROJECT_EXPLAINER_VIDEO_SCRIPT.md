...
```mermaid
flowchart LR
    S1["Scene 1<br/>0:00 - 0:25<br/>The Genesis"]
    S2["Scene 2<br/>0:25 - 0:55<br/>Iconic Landmarks"]
    S3["Scene 3<br/>0:55 - 1:25<br/>3D Digital Twin"]
    S4["Scene 4<br/>1:25 - 1:55<br/>Edge IoT & AI"]
    S5["Scene 5<br/>1:55 - 2:15<br/>ROI & NRI Model"]
    S6["Scene 6<br/>2:15 - 2:30<br/>The Grand Finale"]

    S1 --> S2 --> S3 --> S4 --> S5 --> S6

    style S1 fill:#0f172a,stroke:#d4af37,stroke-width:1px,color:#ffffff
    style S2 fill:#0f172a,stroke:#38bdf8,stroke-width:1px,color:#ffffff
    style S3 fill:#0f172a,stroke:#a855f7,stroke-width:1px,color:#ffffff
    style S4 fill:#0f172a,stroke:#10b981,stroke-width:1px,color:#ffffff
    style S5 fill:#0f172a,stroke:#f59e0b,stroke-width:1px,color:#ffffff
    style S6 fill:#0f172a,stroke:#ef4444,stroke-width:1px,color:#ffffff
```
